...
public class AbstractClassDeclClassDecl extends ProgDeclPart {

    private ClassDecl ClassDecl;

    public AbstractClassDeclClassDecl (ClassDecl ClassDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AbstractClassDeclClassDecl(\n");
