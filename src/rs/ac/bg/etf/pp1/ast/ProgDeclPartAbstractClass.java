...
public class ProgDeclPartAbstractClass extends ProgDeclPart {

    private AbstractClassDecl AbstractClassDecl;

    public ProgDeclPartAbstractClass (AbstractClassDecl AbstractClassDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ProgDeclPartAbstractClass(\n");
